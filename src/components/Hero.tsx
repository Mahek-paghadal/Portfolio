...
export default function Hero() {
  ...
  return (
    <main
      id="home"
      className="scroll-mt-[94px] grid min-h-[75svh] w-full grid-cols-2 items-center gap-8 px-16 max-[1100px]:gap-6 max-[1100px]:grid-cols-[1.05fr_0.95fr] max-[900px]:min-h-[100svh] max-[900px]:grid-cols-[1fr_1fr] max-[900px]:gap-4 max-[900px]:px-6 max-[900px]:pt-0 max-[900px]:mt-0"
    >
      <div className="relative pt-0 pl-28 animate-[fadeUp_0.9s_ease-out_both] max-[900px]:pl-0 max-[900px]:flex max-[900px]:flex-col max-[900px]:justify-center">
        ...
        />
        <h1 className="name-glossy whitespace-nowrap text-[clamp(34px,5vw,64px)] leading-[0.95] tracking-[2px] font-[var(--display)] font-bold max-[900px]:text-[clamp(22px,6vw,36px)] max-[900px]:leading-tight">
          <span className="typing-cursor">
            {typedName}
            <span className="typing-caret" aria-hidden="true" />
          </span>
        </h1>
        <p className="mt-6 max-w-[700px] text-[23px] leading-10 text-slate-300 max-[900px]:text-[13px] max-[900px]:leading-6 max-[900px]:line-clamp-6 max-[900px]:max-w-[220px]">
          Building smooth and user-focused digital experiences is my passion as a creative UI/UX designer and developer.
          I have worked on web and mobile applications using HTML, CSS, JavaScript, Flutter, and React Native, and explored
          cloud technologies to craft modern, scalable solutions.
        </p>
      ...
      <div className="relative grid place-items-center max-[900px]:flex max-[900px]:items-center max-[900px]:justify-center">
        <img
          ...
          alt=""
          aria-hidden="true"
          className={`pointer-events-none absolute right-6 top-10 w-[460px] opacity-90 animate-[float_8s_ease-in-out_infinite] max-[1100px]:right-4 max-[1100px]:w-[380px] max-[900px]:right-0 max-[900px]:top-2 max-[900px]:w-full max-[900px]:max-w-[230px] ${
        ...
        <img
          ...
          width="560"
          height="460"
          className={`relative z-10 h-auto right-2 top-10 w-[480px] max-w-full animate-[float_6s_ease-in-out_infinite] max-[1100px]:right-2 max-[1100px]:top-10 max-[1100px]:w-[420px] max-[900px]:right-0 max-[900px]:top-0 max-[900px]:relative max-[900px]:w-full max-[900px]:max-w-[240px] max-[900px]:animate-none ${
            showMan ? '' : 'hidden'
          }`}
